...
BOARD_MEMBERS = [
    ...
    team_member("board", "Sibeso", "Director Human Resources", "Sibeso is an accomplished Human Resources Manager with over 7 years of professional work experience spanning human resources administration, talent acquisition, and labor relations. Her academic qualifications include a Master's Degree in Employment and Labor Law from the University of Lusaka, a Bachelor's Degree in Cultural Anthropology from the University of Zambia, and both a Diploma and a Certificate in Human Resource Management from the National Institute of Public Administration. She is currently working as Human Resources Manager at Opputune Time Business Consultants.", "images/staff/sibeso.jpg"),
